...
#ifndef SERVO_INTERFACES__SRV__DETAIL__MOVER_SERVO__FUNCTIONS_H_
#define SERVO_INTERFACES__SRV__DETAIL__MOVER_SERVO__FUNCTIONS_H_
 ...
 * )) before or use
 * servo_interfaces__srv__MoverServo_Request__create()
 ...
 * calls
 * servo_interfaces__srv__MoverServo_Request__init().
...
/**
 * It calls
 * servo_interfaces__srv__MoverServo_Request__fini()
 ...
 * servo_interfaces__srv__MoverServo_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * servo_interfaces__srv__MoverServo_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * servo_interfaces__srv__MoverServo_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_servo_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * servo_interfaces__srv__MoverServo_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_servo_interfaces
...
/**
 * It calls
 * servo_interfaces__srv__MoverServo_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_servo_interfaces
...
/**
 * It allocates the memory for the array and calls
 * servo_interfaces__srv__MoverServo_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_servo_interfaces
...
/**
 * It calls
 * servo_interfaces__srv__MoverServo_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * servo_interfaces__srv__MoverServo_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_servo_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * servo_interfaces__srv__MoverServo_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_servo_interfaces
...
/**
 * It calls
 * servo_interfaces__srv__MoverServo_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_servo_interfaces
...
/**
 * It allocates the memory for the array and calls
 * servo_interfaces__srv__MoverServo_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_servo_interfaces
...
/**
 * It calls
 * servo_interfaces__srv__MoverServo_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SERVO_INTERFACES__SRV__DETAIL__MOVER_SERVO__FUNCTIONS_H_

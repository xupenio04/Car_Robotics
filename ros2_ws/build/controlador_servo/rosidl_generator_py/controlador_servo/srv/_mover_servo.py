...
class Metaclass_MoverServo_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('controlador_servo')
        except ImportError:
            import logging
            import traceback
...
class MoverServo_Event(metaclass=Metaclass_MoverServo_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<controlador_servo/MoverServo_Request, 1>',
        'response': 'sequence<controlador_servo/MoverServo_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['controlador_servo', 'srv'], 'MoverServo_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['controlador_servo', 'srv'], 'MoverServo_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from controlador_servo.srv import MoverServo_Request
    ...
    def response(self, value):
        if self._check_fields:
            from controlador_servo.srv import MoverServo_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_MoverServo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'controlador_servo.srv.MoverServo')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from controlador_servo.srv import _mover_servo
...
class MoverServo(metaclass=Metaclass_MoverServo):
    from controlador_servo.srv._mover_servo import MoverServo_Request as Request
    from controlador_servo.srv._mover_servo import MoverServo_Response as Response
    from controlador_servo.srv._mover_servo import MoverServo_Event as Event
